# Generated by Django 4.2.7 on 2025-06-04 06:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, default='category.jpg', null=True, upload_to='category_file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('English', 'English'), ('Hindi', 'Hindi'), ('Spanish', 'Spanish'), ('Gujarati', 'Gujarati')], default='English', max_length=100)),
                ...
                ('plateform_status', models.CharField(choices=[('Review', 'Review'), ('Disable', 'Disable'), ('Rejected', 'Rejected'), ('Draft', 'Draft'), ('Published', 'Published')], default='Published', max_length=100)),
                ('teacher_status', models.CharField(choices=[('Draft', 'Draft'), ('Disable', 'Disable'), ('Published', 'Published')], default='Published', max_length=100)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.FileField(blank=True, default='default-teacher.jpg', null=True, upload_to='teacher_file')),
                ('full_name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.CharField(default=None, max_length=1000, null=True)),
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('New Order', 'New Order'), ('New Review', 'New Review'), ('New Course Question', 'New Course Question'), ('New Course Published', 'Course Published')], max_length=100)),
